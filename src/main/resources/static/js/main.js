...
function slugify(string) {
    const a = 'àáäâãåăæąảạắằẳẵặấầẩẫậçćčđďèéěėëêęẻẽẹếềểễệğǵḧìíïîįiỉĩịłḿǹńňñòóöôœøỏõọốồổỗộơớờởỡợṕŕřßşśšșťțùúüûǘůűūųủũụưứừửữựẃẍÿýỳỷỹỵźžż·/_,:;'
    const b = 'aaaaaaaaaaaaaaaaaaaaacccddeeeeeeeeeeeeeeegghiiiiiiiiilmnnnnooooooooooooooooooooprrsssssttuuuuuuuuuuuuuuuuuuwxyyyyyyzzz------'
